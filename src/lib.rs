...
pub const KNOWN_OPCODES: &[(u32, u32)] = &[
    ...
    (0x71448000, 0xffff8000), // lsx vfscaleb.s
    (0x71450000, 0xffff8000), // lsx vfscaleb.d
    (0x729b8000, 0xffff8000), // lsx vmepatmsk.v
    (0x75448000, 0xffff8000), // lasx xvfscaleb.s
    (0x75450000, 0xffff8000), // lasx xvfscaleb.d
    (0x769b8000, 0xffff8000), // lasx xvmepatmsk.v
];
